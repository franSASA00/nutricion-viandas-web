    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="mb-4 text-emerald-400">🌿 Nutrición & Viandas</h3>
            ...
            <div className="flex gap-4">
                ...
                className="bg-emerald-600 hover:bg-emerald-700 px-4 py-2 rounded-lg transition-colors inline-flex items-center gap-2"
              >
                <span>📱</span>
                <span>WhatsApp</span>
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="#viandas" className="hover:text-emerald-400 transition-colors">
                  🥗 Nuestras Viandas
                </a>
              </li>
              <li>
              ...
              <li>
                  ...
                  href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent("Hola! Quiero información sobre planes personalizados")}`}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>🚚 Reparto gratuito (Consultar zona dentro de Villa Carlos Paz)</li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          ...
          <p className="text-sm">
            Diseñado con 💚 para tu bienestar
          </p>
        </div>
      </div>
    </footer>
